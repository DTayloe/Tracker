...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = $pdo->prepare($sql)){
            ...
            $param_password = $password; // Unsecure - Plaintext password
            // $param_password = password_hash($password, PASSWORD_DEFAULT); // Secure version - Hashed password
